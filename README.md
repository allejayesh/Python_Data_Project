...
[2_Skills_Demand.ipynb](3_Project/2_Skill_Demand.ipynb)
...
- SQL is the most requested skill for Data Analysts and Data Scientists, appearing in over half the job postings for both roles. For Data Engineers, Python is the most sought-after skill, showing up in 68% of job postings.
...
To understand how the demand for key data analyst skills evolved throughout 2023, I analyzed monthly job posting data and visualized the top five most frequently requested skills. This visualization helps highlight how employer priorities shifted over time, showing which tools and skills experienced steady demand, growth, or decline during the year. Tracking these trends provides valuable insights for job seekers about which skills are worth prioritizing based on market needs
...
This helps reveal how compensation varies by seniority, specialization, and responsibilities.
The visualization highlights which roles offer higher earning potential and where major outliers exist.
These insights guide job seekers in understanding which positions provide the strongest salary growth.
...
To explore which skills offer the best earning potential and which are most sought after by employers, I analyzed salary and demand data for common data analyst skills.
This comparison helps highlight the tools that command the highest pay versus those appearing most frequently in job postings.
By visualizing both datasets together, we can clearly see the gap between what pays well and what is widely required.
These insights help job seekers prioritize skills that balance strong demand with competitive compensation.
...
![The Highest Paid & Most In-Demand Skills for Data Analysts in the US](3_Project/Images/salary_analysis1.png)
...
## 4. What is the most optimalskill to learn for Data Analyst?
